...
BENCH_OUTPUT_MODE="${BENCH_OUTPUT_MODE:-deferred}"
...
IOMIX_WORKERS="${IOMIX_WORKERS:-8}"
IOMIX_BYTES="${IOMIX_BYTES:-1G}"
HDD_WORKERS="${HDD_WORKERS:-8}"
HDD_BYTES="${HDD_BYTES:-1G}"
HDD_WRITE_SIZE="${HDD_WRITE_SIZE:-1M}"
HDD_OPTS="${HDD_OPTS:-direct,dsync,fsync}"
